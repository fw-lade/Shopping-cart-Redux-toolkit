  ...
  return (
    <div>
      <div className="rounded-lg ">
        <div className="sm:flex sm:justify-start shadow-md p-6 bg-white rounded-lg mb-6 justify-between items-center">
          {/* product image */}
          <img
            src={image}
            alt=""
          ...
          <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <button onClick={handleRemoveFromCart} className="text-red-500">
                  x
                </button>
              </div>
            </div>
